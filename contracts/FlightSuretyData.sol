...
contract FlightSuretyData {
    ...
    // airlines information data variables
    struct Airline {
    ...
    uint256 public constant insurance_limit = 1 ether;
    uint256 public constant min_funds = 10 ether;

    //multiparty variables- airlines
    uint8 private constant multiparty_min_air = 4;
    ...
    */
    ...
    {
        require(authorizedContracts[msg.sender] == 1, "Caller is not an authorized");
        _;
    }
    ...
    */
    ...
    function isActive ( address airline) public view returns(bool) {
        return(airlines[airline].funded >= min_funds);
    }
    ...
    */
    function registerAirline
                            ...
                            returns (bool)
    {
        require(airlineAddress != address(0), "'airlineAddress' must be a valid.");
        require(!airlines[airlineAddress].isRegistered, "Airline is registered.");

        if(airlinesCount < multiparty_min_air){
            ...
            require(vote(airlineAddress), "An ERR while voting");
        }
        return (true);
    }
    ...
    */
                            ...
                            returns (uint256, address, uint256)
    {
        ...
        require(msg.value > 0, 'You need to pay for buying a flight insurance');
        ...
        if (msg.value > insurance_limit) {
            msg.sender.transfer(msg.value.sub(insurance_limit));
        }
    }
    ...
    */
                            ...
                            returns (uint256, uint256, uint256, uint256, address, address)
    {
        ...
        require(passengers[insuredPassenger].credit > 0, "The company didn't fund with enough money for withdrawal");
        uint256 initialBalance = address(this).balance;
        uint256 credit = passengers[insuredPassenger].credit;
        require(address(this).balance > credit, "The contract does not have enough funds to pay");
