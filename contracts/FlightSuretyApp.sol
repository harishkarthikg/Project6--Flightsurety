...
contract FlightSuretyApp {
    ...
    */
    ...
    {
        require(flightSuretyData.isActive(msg.sender), "This account did not provide enough funds so not operational.");
        _;
    }

    modifier requireAirlineNotVoted(address airlineAddress) {
        require(!checkIfContains(airlineVoters[airlineAddress]), "You already voted online.");
        _;
    }
    ...
    */
                                ...
                                requireIsAirlineActive
    {
        ...
        require(!flights[key].isRegistered, "Flight was registered.");
    ...
    */
                                ...
                                requireIsOperational
    {
        ...
        require(flights[key].isRegistered, "Flight is not yet registered.");
